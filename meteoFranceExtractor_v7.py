...
class MFDayMeaner:
	...
	def getDayMean(self, paramHeader, offset, offsetStatus, absoluTemp, inputable):
		...
		createtablesql = "CREATE TABLE {}.{} (date date, {} float);".format( self.outputschema, inputable, inputable)
				...
				if   (row['date'][8:] == '030000') & (row[paramHeader] != '') :
					...
					if (quartercheck21 == '21') and ( row['date'][8:10] == '00' ) :
						...
						if isnan(average):
							...
							insertintotablesql = 'INSERT INTO {}.{} VALUES ({}, {}) ;'.format(self.outputschema, inputable, date, average)
		...
		print('All averages written to ', inputable)
		self.meanlist00.clear()
		self.meanlist03.clear()
		self.meanlist06.clear()
		self.meanlist09.clear()
...
### température
MFDayMeaner.getDayMean( paramHeader='temperature', offset=0, offsetStatus=False, absoluTemp=True, inputable = 'tmpDB' )

### température + offset
MFDayMeaner.getDayMean( paramHeader='temperature', offset=2, offsetStatus=True, absoluTemp=True, inputable = 'tmpOffset2DB' )

#### Humidité
MFDayMeaner.getDayMean( paramHeader='humidite', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'humidityDB' )

### ptRosée
MFDayMeaner.getDayMean( paramHeader='point_rose', offset=0, offsetStatus=False, absoluTemp=True, inputable = 'ptroseDB' )

### ptRosée + offset
MFDayMeaner.getDayMean( paramHeader='point_rose', offset=2, offsetStatus=True, absoluTemp=True, inputable = 'ptroseOffset2DB' )

### pression atmosphérique
MFDayMeaner.getDayMean( paramHeader='press_sta', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'pressionDB' )

### vvent
MFDayMeaner.getDayMean( paramHeader='vvent', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'vventDB' )

### visibilite
MFDayMeaner.getDayMean( paramHeader='visibilite', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'visibiliteDB' )

### nebulosité relative
MFDayMeaner.getDayMean( paramHeader='nebulosite', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'nebulositeDB' )

### rafale de vent les 10 dernières minutes
MFDayMeaner.getDayMean( paramHeader='rafale_10min', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'rafal_10minDB' )

### précipitation en mm toutes les heures 
MFDayMeaner.getDayMean( paramHeader='precip_01h', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'precip_01hDB' )

### précipitation en mm toutes les 24 heures 
MFDayMeaner.getDayMean( paramHeader='precip_24h', offset=0, offsetStatus=False, absoluTemp=False, inputable = 'precip_24hDB' )

### Température ressentie sur 24h
MFDayMeaner.getDayMean( paramHeader='temp_max_24', offset=0, offsetStatus=False, absoluTemp=True, inputable = 'tempmax24DB' )

### Température ressentie sur 24h + offset
MFDayMeaner.getDayMean( paramHeader='temp_max_24', offset=2, offsetStatus=True, absoluTemp=True, inputable = 'tempmax24Offset2DB' )

### Température ressentie sur 24h
MFDayMeaner.getDayMean( paramHeader='temp_min_24', offset=0, offsetStatus=False, absoluTemp=True, inputable = 'tempmin24DB' )

### Température ressentie sur 24h + offset
MFDayMeaner.getDayMean( paramHeader='temp_min_24', offset=2, offsetStatus=True, absoluTemp=True, inputable = 'tempmin24Offset2DB' )
