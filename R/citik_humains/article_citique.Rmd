---
title: "article_citique"
author: "khaldoune hilami Vincent Godard"
date: "9/8/2021"
...
```{r body, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, results='hide'}



```

## Existe-t-il des conditions météorologiques favorables aux piqûres de tiques ? Utilisation de données issues des sciences participatives et des bases de données météorologiques pour décrire la distribution spatio-temporelle des piqûres de tiques en France métropolitaine.
...
##### **Hilami Khaldoune, Godard Vincent1, Cosson Jean-François2, Noûs Camille**
