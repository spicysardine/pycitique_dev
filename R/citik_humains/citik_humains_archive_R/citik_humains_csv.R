...
## donées darksky avec dates strictes
wdata <- read.csv("citik_humains_clean_weather_strict.csv", sep = ',', quote = "'")
...
# SEX
pie(table(wdata$sex_pique[wdata$sex_pique != '']), cex= 1.5, main = 'Sexe', cex.main=3.5, col = c("#FF8000", "#0080FF") )
...
text(90, 0.06, paste("N =",nr," signalements" ), cex = 2,  col = "black")
...
text(25, 0.10, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(1030, 0.3, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(22, 0.4, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(50, 0.04, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(6, 0.6, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(30, 0.20, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(0.8, 15, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(30, 0.08, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
...
text(23, 0.08, paste("N = ",nr," signalements" ), cex = 2,  col = "black")
text(05, 0.08, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
