...
var <-humdataAL$temperature ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
output_AL=data.frame(aa, ab, ac, ba, bb, bc, ca, cb, cc)
output_AL ## affichage du résultat

write.table(output_AL,"results_AL.txt", append = TRUE, sep=";", col.names = TRUE, row.names = TRUE)
...
write.table(output_AL,"results_AL.txt", append = TRUE, sep=";", row.names = TRUE)
...
var <-humdataAL$temperaturehigh ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$humidity ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$dewpoint ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$pressure ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$windspeed ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$visibility ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$cloudcover ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$windgust ## création d'un vecteur générique (var) pour un remplacement plus aisé
...
var <-humdataAL$uvindex ## création d'un vecteur générique (var) pour un remplacement plus aisé
