...
# SEX
png("./plots_animaux/SEX_animaux.png", width = 1920, height = 1080)
pie(table(wadata$sex_animal[wadata$sex_animal != '']), cex= 1.5, main = 'Sexe', cex.main=3.5, col = c("#FF8000", "#0080FF") )
dev.off()


# Paysage
png("./plots_animaux/Paysage_animaux.png", width = 1920, height = 1080)
...
# Dominante météo
png("./plots_animaux/dometeo_animaux.png", width = 1920, height = 1080)
...
png("./plots_animaux/precisiongeo_animaux.png", width = 1920, height = 1080)
...
# Animal piqué:
png("./plots_animaux/animal_pique.png", width = 1920, height = 1080)
...
# png("./plots_animaux/Histogrammes.png", width = 1920, height = 1080)
# 
# # Humidité
# hist(wadata$humidity, 
#      breaks = 80,
#      col="grey",
...
png("./plots_animaux/humidity_animaux.png", width = 1920, height = 1080)
...
text(90, 0.06, paste("N =",nra," signalements" ), cex = 2,  col = "black")
text(55, 0.05, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/ptRose_animaux.png", width = 1920, height = 1080)
...
text(25, 0.10, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(04, 0.10, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/pression_animaux.png", width = 1920, height = 1080)
...
text(1030, 0.3, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(1010, 0.10, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/visibHoriz_animaux.png", width = 1920, height = 1080)
...
text(22, 0.4, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(20, 0.1, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/nebulosa_animaux.png", width = 1920, height = 1080)
...
text(50, 0.04, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(75, 0.05, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/vvent_animaux.png", width = 1920, height = 1080)
...
text(6, 0.6, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(6, 0.3, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/rafalvent_animaux.png", width = 1920, height = 1080)
...
text(30, 0.20, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(10, 0.10, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/intensPricip1h_animaux.png", width = 1920, height = 1080)
...
text(0.8, 15, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(.4, 5, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/intensPrecip24h_animaux.png", width = 1920, height = 1080)
...
png("./plots_animaux/dayTemp_animaux.png", width = 1920, height = 1080)
...
text(30, 0.08, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(05, 0.08, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/nightTemp_animaux.png", width = 1920, height = 1080)
...
text(23, 0.08, paste("N = ",nra," signalements" ), cex = 2,  col = "black")
text(05, 0.08, paste("M = Mesure Nationale" ), cex = 2 ,  col = "red")
...
png("./plots_animaux/maxTemp_animaux.png", width = 1920, height = 1080)
...
png("./plots_animaux/minTemp_animaux.png", width = 1920, height = 1080)
