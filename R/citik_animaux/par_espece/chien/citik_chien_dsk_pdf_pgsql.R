...
# pdf( file = "../../PDF/citik_maille_42/animaux_42/citik_DSK_vs_DSK/citik_chien_DSK_vs_DSK_charts.pdf",
pdf( file = "../../PDF/citik_maille_700/animaux_700/citik_chien_DSK_vs_DSK_maille_700_charts.pdf",
     onefile = TRUE,
     paper="a4r",
     width = 11,
     height = 9,
