...
select
	...
	date_piqure_saisie,
	annee_extract
From citik.citik_animaux_clean
...
from citik.citik_animaux_clean_weather_strict_raw as jm0

left	join meteo.citik_animaux_clean_weather_strict_raw_jm2 as jm1
			on jm0.id = jm1.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm2 as jm2
			on jm1.id = jm2.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm3 as jm3
			on jm1.id = jm3.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm4 as jm4
			on jm1.id = jm4.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm5 as jm5
			on jm1.id = jm5.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm6 as jm6
			on jm1.id = jm6.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm7 as jm7
			on jm1.id = jm7.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm8 as jm8
			on jm1.id = jm8.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm9 as jm9
			on jm1.id = jm9.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm10 as jm10
			on jm1.id = jm10.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm11 as jm11
			on jm1.id = jm11.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm12 as jm12
			on jm1.id = jm12.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm13 as jm13
			on jm1.id = jm13.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm14 as jm14
			on jm1.id = jm14.id
left	join meteo.citik_animaux_clean_weather_strict_raw_jm15 as jm15
			on jm1.id = jm15.id
;
...
alter table meteo.citik_humains_clean_weather_strict_raw_jm1

alter column date_piqure_saisie_jm1 set data type date using date_piqure_saisie_jm1::date,
...
select round(cloudcover::numeric*100, 2) from meteo.citik_animaux_clean_weather_strict_raw_jm9
...
update meteo.citik_animaux_clean_weather_strict_raw_jm15
set
...
COPY  
meteo.citik_animaux_clean_weather_strict_raw_jm1
TO '/home/beetroot/Developer/python/CNRS/projetCitique/pycitique/data/donnee_J-15/citik_animaux_clean_weather_strict_jm1.csv'  DELIMITER ','  CSV  HEADER ENCODING 'UTF8' ;

*/

select * from meteo.citik_animaux_clean_weather_strict_raw_jm5
order by date_piqure_saisie_jm5
;
